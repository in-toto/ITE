...
combination of these of these things during any part of the life of an ITE.
...
Anyone may be Sponsor for an ITE, though it should be someone familiar enough
...
. **<<submission, Submission>>** - Andrea writes up the proposal using the ITE
  ...
  One of the editors checks the submission and determines it is ready to considered as an ITE.
